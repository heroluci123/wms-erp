...
import { Plus, Search, Trash2, Edit2, FileDown, Package, Clock } from 'lucide-react'
...
export function Produtos() {
  ...
  const [abaAtiva, setAbaAtiva] = useState('PRODUTOS') // PRODUTOS | RASTREIO
  ...
  return (
    <div>
      ...
      <div className="flex gap-4 mb-24 border-b border-border">
        <button 
          className={`px-16 py-8 font-bold ${abaAtiva === 'PRODUTOS' ? 'border-b-2 border-primary text-primary' : 'text-muted'}`}
          onClick={() => setAbaAtiva('PRODUTOS')}
        >
          Cadastro de Produtos
        </button>
        <button 
          className={`px-16 py-8 font-bold ${abaAtiva === 'RASTREIO' ? 'border-b-2 border-primary text-primary' : 'text-muted'}`}
          onClick={() => setAbaAtiva('RASTREIO')}
        >
